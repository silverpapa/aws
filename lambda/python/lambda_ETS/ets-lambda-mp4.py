...
def start_ets_job(region, input_key):
    ...
    mp4_360p_preset_id      = '1351620000001-000040';
    ...
    #}
    mp4_360p = {
        'Key' : 'mp4-360p/' + output_key,
        'PresetId' : mp4_360p_preset_id
    }
    ...
    print 'mp4 job has been created: ', json.dumps(create_job_result['Job'], indent=4, sort_keys=True)
